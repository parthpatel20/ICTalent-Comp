...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        var profileUrl = 'https://tprofile.azurewebsites.net/'; //http://localhost:60290/
        $.ajax({
            url: profileUrl+'/profile/profile/getEmployerProfile',
            headers: {
    ...
    saveData() {
        ...
        var profileUrl = 'https://tprofile.azurewebsites.net/'; //http://localhost:60290/
        $.ajax({
            url: profileUrl+'profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
