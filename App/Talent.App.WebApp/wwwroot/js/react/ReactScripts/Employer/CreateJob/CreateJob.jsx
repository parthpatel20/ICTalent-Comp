...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            var link = param != "" ? listingUrl+'listing/listing/GetJobByToEdit?id=' + param
                : listingUrl+'listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        var listingUrl = 'https://ttalent.azurewebsites.net/'; //http://localhost:51689/ 
        $.ajax({
            url: listingUrl+'listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
   ...
   title(){
    ...
    if(this.state.jobData.id===''||this.state.jobData.id===null){
